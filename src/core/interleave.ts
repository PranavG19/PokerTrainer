...
export const MODULES: readonly ContentModule[] = [
  ...
  },
  {
    ...
    response: 'an-action',
    source: 'src/core/preflop.ts',
    // The RFI blueprint is generated from thresholds (RFI_SPECS), so its spots carry no authored id.
    contentIds: [],
  },
  {
    id: 'preflop-vs-open',
    ...
    stimulus: 'hole-cards-and-a-seat',
    response: 'an-action',
    source: 'src/core/contrastManifest.ts, src/core/preflop.ts (BB defence rules)',
    contentIds: ['sb-squeeze'],
  },
  {
    id: 'postflop-nodes',
